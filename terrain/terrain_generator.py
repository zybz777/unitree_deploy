...
OUTPUT_SCENE_PATH = "../assets/mujoco/unitree_robots/go2/scene_rough.xml"
...
if __name__ == "__main__":
    ...
    # Geometry obstacle
    # geo_type supports "plane", "sphere", "capsule", "ellipsoid", "cylinder", "box"
    # tg.AddGeometry(position=[1.5, 0.0, 0.25], euler=[0, 0, 0.0], size=[1.0, 0.5, 0.5], geo_type="box")
    ...
    # Rough ground
    # tg.AddRoughGround(init_pos=[1, -5.0, 0.0],
    #                   euler=[0, 0, 0.0],
    #                   nums=[150, 50],
    #                   box_size=[0.4, 0.4, 0.50],
    #                   box_euler=[0.0, 0.0, 0.0],
    #                   separation=[0.35, 0.35],
    #                   box_size_rand=[0.05, 0.05, 0.175],
    #                   box_euler_rand=[0.0, 0.0, 0.0],
    #                   separation_rand=[0.05, 0.05],
    #                   )
    ...
    #     position=[0, 0, 0.0],
    #     size=[10.0, 2.0],
    #     height_scale=0.06,  # max height
    #     negative_height=0.06,  # height in the negative direction of z axis
    #     image_width=1000,  # height field image size
    #     img_height=1000,
    #     smooth=100.0,  # smooth scale
    #     perlin_octaves=6,  # perlin noise parameter
    #     perlin_persistence=0.5,
    #     perlin_lacunarity=2.0,
    #     output_hfield_image="../assets/mujoco/unitree_robots/go2/assets/height_field.png"
    # )
